 ...
 */
function getCanvasName(instance) {
 ...
 */
function getCanvasReplay(instance) {
 ...
 */
function wrapObject(o, exclude, getName, log) {
...
function constructImageData(width, height, data) {
    var imageData;
    try {
